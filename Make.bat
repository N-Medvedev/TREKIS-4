   ...
   IF /I "%arg1%"=="debug" (
      ...
      IF  /I "%arg1%"=="debugomp" (
         ...
         IF /I %arg1%==FAST (
            ...
            ifort.exe -c /F9999999999 /fpp /Qopenmp /D OMP_inside /Qmkl=parallel /real-size:64 /Od /fpe:0 /fp:precise /Qvec %List_of_files% /standard-semantics
            ...
            ifort.exe /F9999999999 /fpp /Qopenmp /D OMP_inside /Qmkl=parallel /real-size:64 /Od /fpe:0 /fp:precise /Qvec *.obj   /exe:!Program_name! /standard-semantics
