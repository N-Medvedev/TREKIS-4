...
! Constants:
real(8) :: g_Pi, g_2Pi, g_half_Pi, g_exp, g_e, g_me, g_me_eV, g_cvel, g_c_Afs, g_Mp, g_amu, g_Mn, g_Mn_MeV, &
g_h, g_2Pih, g_kb, g_kb_EV, g_kb_J, g_e0, g_ke, g_mu0, g_Ry, g_a0, g_r0, g_v0, g_alpha, g_P_atm, &
g_e_m, g_h_MeVs, g_e_ESU, g_me_MeV, g_u_MeV, g_re, g_lambda_e, g_SIGMA_0, &
...
real(8) :: g_au2A, g_A2au, g_au2ev, g_ev2au, g_au2am, g_am2au, g_au2fs, g_fs2au, &
g_ev2kc, g_kc2ev, g_au2kc, g_kc2au, g_au2ic, g_ic2au, g_ev2ic, g_ic2ev, g_ev2kj, &
g_in2cm, g_ft2m, g_yd2m, g_cm2in, g_m2ft, g_m2yd, g_ev2Ry, g_deg2rad, g_Afs2ms,  &
g_ms2Afs, g_rad2deg, g_kJmol2eVatom
...
parameter (g_u_MeV	= 931.49432d0)		! unified atomic mass unit [MeV]
parameter (g_cvel	= 299792458.0d0)	! Light velosity	[m/sec]
parameter (g_c_Afs = g_cvel * 1.0d-5)	! Light velosity	[A/fs]
...
parameter (g_M_muon = 1.88353d-28)      ! Muon mass [kg]
...
parameter (g_2Pih = 2.0d0*g_Pi*g_h)         ! Plank constant [J*sec]
...
parameter (g_AUENERGY	= 4.3597482d-18)	! 1 a.u. energy in SI, hartree energy [J]
parameter (g_AUACTION	= 1.05457266d-34)	! 1 a.u. action in SI, Planck constant/(2*PI)
parameter (g_AUTIME	= 2.4188843341d-17)	    ! 1 a.u. time in SI [s]
parameter (g_AUFORCE	= 8.2387295d-08)	! 1 a.u. force in  SI
parameter (g_AUVELOCITY	= 2187691.42d0)		! 1 a.u. velocity in SI [m/s]
...
parameter (g_AUMDIPOLE	= 1.85480308d-23)	! 1 a.u. magn. dipole in SI
parameter (g_ASTRONOMICALUNIT	= 14959787d0)	! 1 AE length in SI [m]
...
parameter (g_kJmol2eVatom = 0.1036426985e-1)    ! [kJ/mol] -> [eV/atom]
...
parameter (g_deg2rad = g_Pi/180.0d0)	        ! [degrees] -> [radians]
parameter (g_rad2deg = 180.0d0/g_Pi)	        ! [radians] -> [degrees]
